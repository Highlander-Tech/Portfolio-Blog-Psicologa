  ...
  return (
    <Box as="section" w="full" bgColor="brown" py="40px">
      ...
      >
        ...
        te ajudar com a minha experiencia em clínica e agora levando isso para o
        on line.
        <br />
        <br />
        Se você está sentindo-se perdido e sem propósito, pode contar comigo
        para te ajudar a compreender que tuas dúvidas e inquietações fazem parte
        deste processo da adolescência.
        <br />
      ...
      {isWideVersion && (
        <NavButton border="1px" borderColor="beige.100" ml="60%" mt="50px">
          Agende
        </NavButton>
      )}
    </Box>
